...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(75, 60, 253, 42);
		...
		txtValor.setBounds(78, 328, 190, 33);
		...
		txtFormaPago.setModel(new DefaultComboBoxModel<String>(new String[] {"Tarjeta de Cr�dito", "Tarjeta de D�bito", "Dinero en efectivo"}));
	...
	private void guardarReserva() {	
		...
		JOptionPane.showMessageDialog(null,"Registro Guardado con �xito " + nuevaReserva.getId());
