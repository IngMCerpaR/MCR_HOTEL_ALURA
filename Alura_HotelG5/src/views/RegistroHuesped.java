...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] {"afgano-afgana", "alemán-alemana", ""
																		...
																		+ "belga-belga", "boliviano-boliviana", ""
																		+ "brasileño-brasileña", "camboyano-camboyana", ""
																		+ "canadiense-canadiense", "chileno-chilena", ""
																		+ "chino-china", "colombiano-colombiana", ""
																		+ "coreano-coreana", "costarricense-costarricense", ""
																		+ "cubano-cubana", "danés-danesa", ""
																		+ "ecuatoriano-ecuatoriana", "egipcio-egipcia", ""
																		+ "salvadoreño-salvadoreña", "escocés-escocesa", ""
																		+ "español-española", "estadounidense-estadounidense", ""
																		+ "estonio-estonia", "etiope-etiope", "filipino-filipina", ""
																		+ "finlandés-finlandesa", "francés-francesa", "galés-galesa", ""
																		+ "griego-griega", "guatemalteco-guatemalteca", "haitiano-haitiana", ""
																		+ "holandés-holandesa", "hondureño-hondureña", "indonés-indonesa", ""
																		+ "inglés-inglés", "iraquí-iraquí", "iraní­-iraní", ""
																		+ "irlandés-irlandesa", "israelí-israelí", ""
																		+ "italiano-italiana", "japonés-japonesa", "jordano-jordana", ""
																		+ "laosiano-laosiana", "letón-letona", "letonés-letonesa", ""
																		+ "malayo-malaya", "marroquí-marroquí", "mexicano-mexicana", ""
																		+ "nicaragüense-nicaragüense", "noruego-noruega", ""
																		+ "neozelandés-neozelandesa", "panameño-panameña", "paraguayo-paraguaya", ""
																		+ "peruano-peruana", "polaco-polaca", "portugués-portuguesa", ""
																		+ "puertorriqueño-puertorriqueña", "dominicano-dominicana", ""
																		+ "rumano-rumana", "ruso-rusa", "sueco-sueca", "suizo-suiza", ""
																		+ "tailandés-tailandesa", "taiwanes-taiwanesa", "turco-turca", ""
																		+ "ucraniano-ucraniana", "uruguayo-uruguaya", ""
		...
		lblNewLabel_4.setBounds(555, 55, 285, 42);
